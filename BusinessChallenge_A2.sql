...
DROP TEMPORARY TABLE IF EXISTS wedding_proposal;

CREATE TEMPORARY table wedding_Proposal AS 

# Flower Department 
SELECT 
'Wedding Arch' AS Object, 
MAX(CASE WHEN vendor_id LIKE "flo%%" AND price_id = 1 AND avg_reviews > 4.8 AND county = 'Contra Costa County' THEN vendor_id END) AS Vendor,
'Flowers' as Department, 
'1' as Quantity,
'810.5' AS Price_Per_QTY, 
'810.5' AS Total_cost 
FROM temp_wedding_db_team2
UNION 
SELECT 
'Bride Bouqet' AS Object, 
MAX(CASE WHEN vendor_id LIKE "flo%%" AND price_id = 1 AND avg_reviews > 4.8 AND county = 'Contra Costa County' THEN vendor_id END) AS Vendor,
'Flowers' as Department, 
'1' as Quantity, 
'350' AS Price_Per_QTY,
'350' AS Total_cost  
FROM temp_wedding_db_team2 
UNION 
SELECT 
'Bridesmaid Bouqet' AS Object, 
MAX(CASE WHEN vendor_id LIKE "flo%%" AND price_id = 1 AND avg_reviews > 4.8 AND county = 'Contra Costa County' THEN vendor_id END) AS Vendor,
'Flowers' as Department, 
'1' as Quantity,
'123' AS Price_Per_QTY, 
'123' AS Total_cost 
FROM temp_wedding_db_team2 
UNION 
SELECT 
'Flower Wall' AS Object, 
MAX(CASE WHEN vendor_id LIKE "flo%%" AND price_id = 1 AND avg_reviews > 4.8 AND county = 'Contra Costa County' THEN vendor_id END) AS Vendor,
'Flowers' as Department, 
'1' as Quantity, 
'550' AS Price_Per_QTY,
'550' AS Total_cost  
FROM temp_wedding_db_team2 
UNION 
SELECT 
'table Flower Centerpieces' AS Object, 
MAX(CASE WHEN vendor_id LIKE "flo%%" AND price_id = 1 AND avg_reviews > 4.8 AND county = 'Contra Costa County' THEN vendor_id END) AS Vendor,
'Flowers' as Department, 
'5' as Quantity,
'150' AS Price_Per_QTY, 
'750' AS Total_cost 
FROM temp_wedding_db_team2 
...
UNION 
SELECT 
'Del Monte Courtyard Ceremony and Reception Package' AS Object, 
MAX(CASE WHEN vendor_id LIKE "ven%%" AND wedding_size = 'small' THEN vendor_id END) AS Vendor, 
'Venue' as Department, 
'1' as Quantity, 
'2000' AS Price_Per_QTY,
'2000' AS Total_cost  
FROM temp_wedding_db_team2 
...
UNION 
SELECT 
'DJ Service' AS Object, 
MAX(CASE WHEN vendor_id LIKE "mus%%" AND price_id = 1 AND avg_reviews >4.5 THEN vendor_id END) AS Music, 
'Music' as Department, 
'1' as Quantity,
'1395' AS Price_Per_QTY, 
'1395' AS Total_cost 
FROM temp_wedding_db_team2 
...
UNION 
SELECT 
'Bride Wedding Band' AS Object, 
MAX(CASE WHEN vendor_id LIKE "jwl%%" AND price_id = 1 AND avg_reviews >4.5 THEN vendor_id END) AS Jewlery, 
'Jewlery' as Department, 
'1' as Quantity, 
'1960' AS Price_Per_QTY,
'1960' AS Total_cost  
FROM temp_wedding_db_team2
UNION 
SELECT 
'Groom Wedding Band' AS Object, 
MAX(CASE WHEN vendor_id LIKE "jwl%%" AND price_id = 1 AND avg_reviews >4.5 THEN vendor_id END) AS Jewlery, 
'Jewlery' as Department, 
'1' as Quantity,
'1495' AS Price_Per_QTY, 
'1495' AS Total_cost 
FROM temp_wedding_db_team2
...
UNION 
SELECT 
'Photography All Day Service' AS Object, 
MAX(CASE WHEN vendor_id LIKE "pho%%" AND price_id = 1 AND photographer = 1 AND avg_reviews > 4.5 THEN vendor_id END) AS Photo_and_Video,
'Photo and Video' as Department, 
'1' as Quantity,
'1999' AS Price_Per_QTY, 
'1999' AS Total_cost  
FROM temp_wedding_db_team2
...
UNION 
SELECT 
'Hair Service' AS Object, 
MAX(CASE WHEN vendor_id LIKE "hai%%" AND price_id = 1 AND county = 'Contra Costa County' and avg_reviews > 4.8 THEN vendor_id END) AS Hair_and_Makeup, 
'Hair and Makeup' as Department, 
'1' as Quantity,
'300' AS Price_Per_QTY, 
'300' AS Total_cost 
FROM temp_wedding_db_team2
...
UNION 
SELECT 
'First Appointment' AS Object, 
MAX(CASE WHEN vendor_id LIKE "dre%%" AND price_id = 1 AND county = 'Santa Clara County' THEN vendor_id END) AS Attire, 
'Dress & Attire' as Department, 
'1' as Quantity, 
'60' AS Price_Per_QTY,
'60' AS Total_cost
FROM temp_wedding_db_team2
UNION 
SELECT 
'Alteration' AS Object, 
MAX(CASE WHEN vendor_id LIKE "dre%%" AND price_id = 1 AND county = 'Santa Clara County' THEN vendor_id END) AS Attire, 
'Dress & Attire' as Department, 
'1' as Quantity,
'1000' AS Price_Per_QTY, 
'1000' AS Total_cost
FROM temp_wedding_db_team2
UNION 
SELECT 
'Groom Suit Rental' AS Object, 
MAX(CASE WHEN vendor_id LIKE "dre%%" AND price_id = 1 AND county = 'Santa Clara County' THEN vendor_id END) AS Attire, 
'Dress & Attire' as Department, 
'1' as Quantity,
'425' AS Price_Per_QTY, 
'425' AS Total_cost 
FROM temp_wedding_db_team2
...
SELECT 
'Food' AS Object, 
MAX(CASE WHEN vendor_id LIKE "cat%%" AND vendor_id = 'cat30' THEN vendor_id END) AS Catering, ## change 
'Catering' as Department, 
'47' as Quantity, 
'25' AS Price_Per_QTY,
'1175' AS Total_cost 
FROM temp_wedding_db_team2
...
UNION 
SELECT 
'Candle Centerpiece (3 Branch Candle Stand)' AS Object, 
MAX(CASE WHEN vendor_id LIKE "ren%%" AND price_id = 3 AND rent_decor =1 AND rent_table_and_chairs =1 AND rent_tableware =1 AND rent_lighting = 1 THEN vendor_id END) AS Rentals, 
'Rentals' as Department, 
'5' as Quantity, 
'17.50' AS Price_Per_QTY,
'87.5' AS Total_cost 
FROM temp_wedding_db_team2

# Invitations Department 
UNION 
SELECT 
'Tri Fold Card' AS Object, 
MAX(CASE WHEN vendor_id LIKE "inv%%" AND price_id = 1 AND avg_reviews > 4.9 THEN vendor_id END) AS Invitations,
'Invitations' as Department, 
'50' as Quantity, 
'1.60' AS Price_Per_QTY,
'80' AS Total_cost 
FROM temp_wedding_db_team2 
UNION 
SELECT 
'Die Cut Card (3 Per Invitation)' AS Object, 
MAX(CASE WHEN vendor_id LIKE "inv%%" AND price_id = 1 AND avg_reviews > 4.9 THEN vendor_id END) AS Invitations,
'Invitations' as Department, 
'150' as Quantity, 
'1.05' AS Price_Per_QTY,
'157.5' AS Total_cost 
FROM temp_wedding_db_team2 
...
UNION 
SELECT 
'Macaron Tower Cake' AS Object, 
MAX(CASE WHEN vendor_id LIKE "cak%%" AND other_desert = 1 OR cake_delivery_and_setup=1 OR cake_stands=1 OR cake_custom_orders =1 OR cake_buffet_style =1 THEN vendor_id END) AS Cake, 
'Cake' as Department, 
'1' as Quantity, 
'275' AS Price_Per_QTY,
'275' AS Total_cost 
FROM temp_wedding_db_team2 
...
UNION 
SELECT 
'Planner Day Of Service ' AS Object, 
 MAX(CASE WHEN vendor_id LIKE "wed%%" AND price_id = 1 AND avg_reviews = 5 AND reviews >30 THEN vendor_id END) AS Planner,
'Wedding Planner' as Department, 
'1' as Quantity, 
'1250' AS Price_Per_QTY,
'1250' AS Total_cost 
FROM temp_wedding_db_team2 

;

SELECT * FROM Wedding_proposal; 
